...
#include "AndyCADMFC.h" //I just added this include AndyCADMFC.
#include "clipper.h"
#include <cmath>
#include <math.h>
#include <vector>
...
bool Clipper::ExecuteInternal()
{
  ...
  if (succeeded)
  {
    ...
    for (PolyOutList::size_type i1 = 0; i1 < m_PolyOuts.size(); ++i1)
    {
      OutRec *outRec = m_PolyOuts[i1];
  ...
  for (int i = 0; i < m_polyNodes.ChildCount(); i++)
  {
    ...
    else
    {
      ...
      for (int j3 = len - 1; j3 > 0; j3--)
        m_normals[j3] = DoublePoint(-m_normals[j3 - 1].X, -m_normals[j3 - 1].Y);
