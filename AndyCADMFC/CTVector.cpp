...
void CTVector::InitCamView(string s,CAABB& box)
{
...
void CTVector::setsnapplane(string s)
{
	CVector v,servant;
...
void CTVector::savefile(fstream &file)
{
	CVector servant;
...
void CTVector::openfile(fstream &file)
{
	CVector servant;
...
long CTVector::Readfile(fstream &file)
{
	CVector servant;
