// Crypto1.cpp: implementation of the CCrypto class.
//
//////////////////////////////////////////////////////////////////////
...
bool CCrypto::InternalDecrypt(const CByteArray& arSource)
{
	...
	m_file.Write(arSource.GetData(), static_cast<UINT>(arSource.GetSize()));
	m_file.Flush();
	...
	DWORD dwDataLength = static_cast<DWORD>(arSource.GetSize());
