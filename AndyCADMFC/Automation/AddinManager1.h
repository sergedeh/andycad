...
public:
	...
	LPDISPATCH/*IProjectFrameworkAddin**/ m_pProjectFrameworkAddin;
...
private:
	...
	CComPtr<IAndyCad> m_ProjectFrameworkObject;
	HRESULT LoadAllAdins(BSTR strAddinLoadingInfo,IAndyCad* pProjectFramework);
public:
	void SendStatus(CString s);
