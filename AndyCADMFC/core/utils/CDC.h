...
public:
    ...
    CDC() {}
    virtual ~CDC() {}
    void Polyline(LPPOINT points, int count) {}
    void Polyline(const void* points, int count) {} 
    void Rectangle(int x, int y, int w, int h) {}
    template<typename RectType> void Rectangle(const RectType& r) {}
    void BeginPath() {}
    void EndPath() {}
    void FillPath() {}
    void* SelectObject(void* obj) { return 0; }
    CPen* SelectObject(CPen* obj) { return 0; }
    CBrush* SelectObject(CBrush* obj) { return 0; }
    ...
    void TextOut(int x, int y, const std::string& s) {}
    int SetROP2(int mode) { return 0; }
