...
class CCadDoc;
class CFigure;
class CCadView : public CScrollView,public CSubject 
{
...
//	CSubWnd m_wndsub;
	enum {Circle,Line,Rectangle,Rectanglefree,FreeLine,select,rotate,scale,\
		text,alignbyline,circle2,circle3,\
		...
		spoint,fill,box,camset,sphere,plane} menu;
	enum {addnode,deletenode,breakcurve,closecurve,group,ungroup,sendbgr,sendfront,sendforward,sendbackward,nothing} submenu;
